...
<html lang="en">
  <head>
  	<title>What's in this course for you | eLearning</title>
    <meta charset="utf-8">
      ...
      <div id="content" class="p-4 p-md-5 pt-5" style="background-color: #f5f5f5; position: relative;">
        ...
        <div class="content-holder">
          <video controls autoplay width="100%" id="my-video">
            <source src="videos/01-whats-in-this-course-for-you.mp4" type="video/mp4">
                <track default src="subtitle/01-whats-in-this-course-for-you.vtt">
