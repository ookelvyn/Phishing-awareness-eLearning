...
<html lang="en">
  <head>
  	<title>Targets of phishing attacks | eLearning</title>
    <meta charset="utf-8">
      ...
      <div id="content" class="p-4 p-md-5 pt-5" style="background-color: #f5f5f5; position: relative;">
        ...
        <div class="content-holder">
          <video controls autoplay width="100%" id="my-video">
            <source src="videos/11-common-target-of-phishing-attacks.mp4" type="video/mp4">
              <source src="video.webm" type="video/webm">
                <track default src="subtitle/11-common-target-of-phishing-attacks.vtt">
