...
<html lang="en">
  <head>
  	<title>Red flags on phishing emails | eLearning</title>
    <meta charset="utf-8">
      ...
      <div id="content" class="p-4 p-md-5 pt-5" style="background-color: #f5f5f5; position: relative;">
        ...
        <div class="content-holder">
          <video controls autoplay width="100%" id="my-video">
            <source src="videos/21-red-flags-on-email.mp4" type="video/mp4">
              <source src="video.webm" type="video/webm">
                <track default src="subtitle/21-red-flags-on-email.vtt">
