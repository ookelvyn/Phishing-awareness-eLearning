...
<html lang="en">
  <head>
  	<title>Excercise 1 | eLearning</title>
    <meta charset="utf-8">
        ...
        <div class="content-holder" >
          ...
          <div class="answers">
            <div class="form-check">
              ...
              <label class="form-check-label opt1" for="flexRadioDefault1">
                An employee of the organization was deceived by a scammer and voluntarily given out the information or clicked on a malicious link.
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="option" id="flexRadioDefault2" value="B" required>
              <label class="form-check-label" for="flexRadioDefault2">
                Sophisticated criminal hackers infiltrated the organization's network and absconded with the data.
              </label>
            </div>
          </div> <!-- End answers -->
